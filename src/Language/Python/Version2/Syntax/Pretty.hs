-----------------------------------------------------------------------------
-- |
-- Module      : Language.Python.Version2.Syntax.Pretty 
...
-- Portability : ghc
--
-- Pretty printing of the Python version 2.x abstract syntax. 
-----------------------------------------------------------------------------

module Language.Python.Version2.Syntax.Pretty where

import Language.Python.Common.PrettyClass
import Language.Python.Version2.Syntax.AST 
